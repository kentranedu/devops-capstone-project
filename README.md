...
![Build Status](https://github.com/kentranedu/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
The project applies Agile planning, test-driven development, continuous integration, secure coding, containerization, Kubernetes deployment, and Tekton-based continuous delivery to build and deliver a RESTful customer account service.
